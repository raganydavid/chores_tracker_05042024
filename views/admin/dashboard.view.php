...
<div class=" border-8 border-black mt-4 rounded-md"> 
 ...
 <div class="flex flex-wrap">
    <a class="flex p-2 m-2 border-4 border-black items-center gap-4 bg-green-300 hover:bg-green-500 max-w-[220px] text-3xl sm:text-xl rounded-md mb-2 group" href="create_chore.php">CREATE CHORE<span class="text-5xl">+</span></a>
    <button class="flex p-2 m-2 border-4 border-black items-center gap-4 bg-green-300 hover:bg-green-500 max-w-[220px] text-3xl sm:text-xl rounded-md mb-2 group disabled:bg-gray-500" <?php if($model5 == false){echo 'disabled';} ?> id="add_new_member_btn">ADD MEMBER <span class="text-5xl">+</span></button>
    <button class="flex p-2 m-2 border-4 border-black items-center gap-4 bg-red-300 hover:bg-red-500 max-w-[220px] text-3xl sm:text-xl rounded-md mb-2 group" id="remove_member_btn">REMOVE MEMBER <span class="text-5xl">-</span></button>
</div>
